...
!define INSTALLSIZE 27604.38


Name "${COMPANYNAME} - ${APPNAME}"
Icon "water_hammer_simulation.ico"

OutFile "water_hammer_simulation_win64_install_4.7.5.exe"

Icon "water_hammer_simulation.ico"
UninstallIcon "water_hammer_simulation.ico"


DirText "Uninstall previous version if exist and Choose directory for installing (Water Hammer Simulation) Ver 4.7.5 (1 April 2024)"

InstallDir "$PROGRAMFILES\water_hammer_simulation"

Section "Install"
  SetOutPath $INSTDIR
  File "C:\Qt\6.5.3\mingw_64\bin\libgcc_s_seh-1.dll"
  File "C:\Qt\6.5.3\mingw_64\bin\libstdc++-6.dll"
  File "C:\Qt\6.5.3\mingw_64\bin\libwinpthread-1.dll"
  File "C:\Qt\6.5.3\mingw_64\bin\Qt6Core.dll"
  File "C:\Qt\6.5.3\mingw_64\bin\Qt6Gui.dll"
  File "C:\Qt\6.5.3\mingw_64\bin\Qt6PrintSupport.dll"
  File "C:\Qt\6.5.3\mingw_64\bin\Qt6Widgets.dll"
CreateDirectory $INSTDIR\platforms
SetOutPath $INSTDIR\platforms
  File "C:\Qt\6.5.3\mingw_64\plugins\platforms\qwindows.dll"
SetOutPath $INSTDIR 
