...
public slots:
    ...
    // HAF 10-4-2023
    void calculSurgeTanksYmax();
    double functionfSurgeTanksYmax(double ymax, double Betta, double hL);
    void calculQtoVSurgeTanksYmax();
    void calculVtoQSurgeTanksYmax();

private slots:
    void on_tabWidget_ce_currentChanged(int index);
    void about();
    void help();
    #if defined(Q_OS_ANDROID)
        void on_doubleSpinBox_LimitUp_valueChanged(double arg1);
        void on_doubleSpinBox_LimitDown_valueChanged(double arg1);
    #endif

    void on_comboBox_Anim_Valid_currentIndexChanged(int k);

    void on_horizontalSlider_k_valueChanged(int value);
